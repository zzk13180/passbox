...
export class PositionService {
  ...
  getScrollParent(element) {
    ...
    for (
      ...
      parent.parentElement !== this.documentRef.body
    ) {
    ...
    switch (placementPrimary) {
      case 'top':
        ...
        targetElPosition.left =
          placementSecondary === 'right'
            ? shiftWidth[placementSecondary] - targetElement.offsetWidth
      ...
      case 'left':
        targetElPosition.top =
          placementSecondary === 'bottom'
            ? shiftHeight[placementSecondary] - targetElement.offsetHeight
  ...
  private isInViewPort(ele, { offsetLeft, offsetTop }) {
    ...
    const viewPortWidth =
      ...
      this.documentRef.body.clientWidth
    ...
    const scrollTop =
      this.documentRef.documentElement.scrollTop || this.documentRef.body.scrollTop
    const top = offsetTop - scrollTop
    offsetLeft = offsetLeft || ele.offsetLeft
    const scrollLeft =
      this.documentRef.documentElement.scrollLeft || this.documentRef.body.scrollLeft
  ...
  private offsetParent(element: HTMLElement): HTMLElement {
    let offsetParentEl =
      <HTMLElement>element.offsetParent || this.documentRef.documentElement

    while (
      offsetParentEl &&
      offsetParentEl !== this.documentRef.documentElement &&
